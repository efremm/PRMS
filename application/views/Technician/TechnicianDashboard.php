          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              <div class="navbar-header"><a id="toggle-btn" href="#" class="menu-btn"><i class="icon-bars"> </i></a><a href="index.html" class="navbar-brand">
                  <div class="brand-text d-none d-md-inline-block"> <span class="text-warning fa 2xfa"><strong><h3>&nbsp; Patient&nbsp;</strong><strong class="text-warning">Record Managment &nbsp;System</h3></strong></span></div></a></div>
          ...
          <div class="row">
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Total Patient Treatment</strong>
                   <div class="count-number text-primary"><?php echo $cnt_pmd;?></div>
                </div>
              </div>
            </div>
            <!-- Count item widget-->
