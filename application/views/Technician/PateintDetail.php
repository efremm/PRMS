    ...
    <div class="page">
      ...
      <section class="dashboard-counts section-padding">
        <div class="container">
          <div class="row">
                       <!-- body-->
           <form   method="post" action="<?php echo base_url()?>Reception_C/UpdatePatient">
               <div class="container row">
                  <div class="col-lg-12"> <h2 style="font-family: sans-serif;background-color: silver">Update Patient Info</h2></div>
                        <hr>
                   ...
                   if(isset($fetch_data))
                      ...
                      <div class="form-label-group col-lg-4">
                            ...
                            <input type="text" class="form-control" id="patientid" name="patientid" placeholder="Insert patient ID"  value="<?php echo $row->patient_ID; ?>" required autofocus readonly>
                           <span class="text-danger"><?php echo form_error("patient_ID"); ?></span>
                        </div>
                       <div class="form-label-group col-lg-4">
                            <label for="firstname">First Name</label>
                            <input type="text" class="form-control" id="firstname" name="firstname" placeholder="Insert user name"  value="<?php echo $row->first_name; ?>"  required autofocus readonly>
                           <span class="text-danger"><?php echo form_error("firstname"); ?></span>
                        </div>
                             <div class="form-label-group col-lg-4" hidden="">
                            <label for="middlename">Middle Name</label>
                            <input type="text" class="form-control" id="middlename" name="middlename" 
                            placeholder  value="<?php echo $row->middle_name; ?>" autofocus> <span class="text-danger"><?php echo form_error("middlename"); ?></span>
                      ...
                      <div class="form-label-group col-lg-4" hidden="">
                        ...
                        <input type="text" class="form-control" id="age" name="age" placeholder="Age"  value="<?php echo $row->age; ?>" required autofocus readonly>
                     ...
                     <div class="form-label-group col-lg-4">
                        ...
                        <input type="text" class="form-control" id="patientcase" name="patientcase" placeholder="patientcase" value="<?php echo $row->patient_case; ?>"  required autofocus readonly><span class="text-danger"><?php echo form_error("patientcase"); ?></span>
                       </div>
                        <div class="form-label-group col-lg-4">
                        <label for="starteddate">Phone No</label>
                        <input type="text" class="form-control" id="starteddate" name="starteddate" placeholder="starteddate" value="<?php echo $row->started_date; ?>"  required autofocus readonly><span class="text-danger"><?php echo form_error("starteddate"); ?></span>
                     </div>
                  
                     <div class="form-label-group col-lg-4">
                        <label for="regdate">Registration Date</label>
                        <input type="date" class="form-control" id="regdate" name="regdate" placeholder="registration date" value="<?php echo $row->registration_date; ?>"  required autofocus readonly><span class="text-danger"><?php echo form_error("regdate"); ?></span>
                       </div>
                    <div class="form-label-group col-lg-4" hidden="">
                 ...
                 <div class="col-lg-12 bg-warning">
                  <span class="fa fa-user">Assign Technician</span>
                  <!-- <hr></hr> -->
                 </div>
                      ...
                      <!-- <div class="form-label-group col-lg-4">
                        <label for="assignedby">Blood Result</label>
                        <input  type="text" class="form-control  text-danger" id="assignedby" name="assignedby" placeholder="assignedby"  autofocus>
                        <span class="text-danger"><?php echo form_error("assignby"); ?></span>
                    </div>
                     <div class="form-label-group col-lg-4">
                        <label for="assignedby">Stool Result</label>
                        <input  type="text" class="form-control  text-danger" id="assignedby" name="assignedby" placeholder="assignedby"  autofocus>
                        <span class="text-danger"><?php echo form_error("assignby"); ?></span>
                    </div>
                     <div class="form-label-group col-lg-4">
                        <label for="assignedby">Pea Result</label>
                        <input  type="text" class="form-control  text-danger" id="assignedby" name="assignedby" placeholder="assignedby"  autofocus>
                        <span class="text-danger"><?php echo form_error("assignby"); ?></span>
                    </div> -->
                     <div class="form-label-group col-lg-4" >
                    ...
                    <div class="form-label-group col-lg-4">
                        ...
                        <input  type="text" class="form-control bg-success text-danger" id="assignedby" name="assignedby" placeholder="assignedby"  autofocus value="<?php echo $this->session->userdata('username');?>" >
                        <span class="text-danger"><?php echo form_error("assignby"); ?></span>
                    </div>
                    <div class="form-label-group col-lg-4">
