      ...
      <section class="dashboard-counts section-padding">
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="container">
                       <div class="col-lg-12">  
                   <?php echo anchor('Reception_C/PatientReg','Add Patient',['class'=>'btn btn-info']);?>
                  </div>
                            ...
                            <tbody>
                              ...
                              <tr>
                               ...
                               <td class="text-success"><?php echo $post->assigned_status;?></td>
                                ...
                                <td> <a class=" btn btn-warning" href="<?php echo base_url("Reception_C/patient_info_fetch/{$post->patient_ID}")?>">
