      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
         ...
         <div class="sidenav-header-inner text-center"><img src="<?php echo base_url('/images/icon.PNG'); ?> "  alt="person" class="img-fluid rounded-circle">
          ...
          <div class="sidenav-header-logo"><a href="index.html" class="brand-small text-center"> <strong>B</strong><strong class="text-primary">PRMS</strong></a></div>
        </div>
            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              <div class="navbar-header"><a id="toggle-btn" href="#" class="menu-btn">
                <i class="icon-bars"> </i></a><a href="index.html" class="navbar-brand">
                  <div class="brand-text d-none d-md-inline-block"><h5><strong class="text-primary"> Patient Record Managment System </strong></h5></div>
                        <div class="brand-text d-none d-md-inline-block"><span class="text-warning">  FOR KOLFE HEALTH CENTER </span></div>
                     </a>
                    </div>
          ...
          <div class="row">
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Total Patient</strong>
                  <div class="count-number text-primary"><?php echo $cnt_Patient;?></div>
                </div>
              </div>
            </div>
