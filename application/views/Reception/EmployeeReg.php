      ...
      <section class="dashboard-counts section-padding">
        <div class="container">
          <div class="row">
            ...
            <!-- body-->
               <form   method="post" action="<?php echo base_url()?>Reception_C/AddEmployee">
          ...
          <div class="container  " style="background-color: green;">
            ...
            <div class="container  " style="background-color: red;"> -->
               ...
               <div class="form-label-group col-lg-4">
                        ...
                        <input type="text" class="form-control" id="employeeid" name="employeeid" placeholder="Insert employeeid id"  autofocus>
                    ...
                    <div class="form-label-group col-lg-4">
                     ...
                     <div class="form-label-group col-lg-4">
                        ...
                        <input type="date" class="form-control" id="hired_date" name="hireddate" placeholder="hired_date"  autofocus>
                         <span class="text-danger"><?php echo form_error("hired_date"); ?></span>
                    </div>
                    
                    <div class="form-label-group col-lg-4">
                        <label for="emp_type">emp_type</label>
                        <input type="text" class="form-control" id="emp_type" name="emptype" placeholder="emptype"  autofocus>
