               ...
               <div class="container row">
                   ...
                   if(isset($fetch_data))
                     ...
                     <div class="form-label-group col-lg-4">
                        ...
                        <input type="text" class="form-control" id="patientcase" name="patientcase" placeholder="patientcase" value="<?php echo $row->patient_case; ?>"  required autofocus><span class="text-danger"><?php echo form_error("patientcase"); ?></span>
                         ...
                         <div class="form-label-group col-lg-4">
                        <label for="cardpayment">Card Payment/birr.</label>
                        <input type="text" class="form-control" id="cardpayment" name="cardpayment" placeholder="cardpayment"  value="<?php echo $row->card_payment; ?>" autofocus>
                 ...
                 <div class="col-lg-12 bg-warning">
                  ...
                  <!-- <hr></hr> -->
                      ...
                      <div class="form-label-group col-lg-4" readonly hidden="">
                        <label for="assignedroom">Assigned Room</label>
                        <select class="form-control text-danger" id="assignedroom" name="assignedroom" disabled="">
                        ...
                        <select class="form-control text-danger" id="assigneddoctor" name="assigneddoctor" disabled="">
                            
                            <option class="text-danger" value="<?php echo $row->assigned_doctor; ?>"><?php echo $row->assigned_doctor; ?></option>
                            <option class="text-success" value="dr">dr</option>
                            <option class="text-success" value="dr1">dr1</option>
                     ...
                     <div class="form-label-group col-lg-4" hidden="">
                        ...
                        <input  type="date" class="form-control" id="assigneddate" name="assigneddate" placeholder="assigneddate" value="<?php echo $row->assigned_date; ?>" autofocus readonly>
                    ...
                    <div class="form-label-group col-lg-4" hidden="">
                        ...
                        <select class="form-control" id="assignedstatus" name="assignedstatus" readonly disabled="">
