      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
         ...
         <div class="sidenav-header-inner text-center"><img src="<?php echo base_url('/images/icon.PNG'); ?> "  alt="person" class="img-fluid rounded-circle">
            <h2 class="h5">PRMS</h2><span class="text-info">@KHC</span>
          </div>
          ...
          <div class="row">
            <!-- body-->
                ...
                <?php if($scsmsg = $this->session->flashdata('successmsg'));?>
                 ...
                 Patient Assignment to Respective Doctor Room
                  </div>
                         ...
                         <table id="tbluser"  name="tbluser" class="table table-responsive table-striped table-bordered" style="width:100%">
                            <thead>
                              <tr>
                                ...
                                <th >age</th>
                                 <th>address</th>
                                 <th class="text-primary">patient_case</th>
                                 <th class="text-primary">assigned_room</th>
                                 <th class="text-primary">assigned_doctor</th>
                                <th class="text-danger">Assigned_date</th>
                                <th class="text-danger">Assigned_by</th>
                                <th class="text-warning">Assign</th>
                                    </tr>
                            </thead>
                            <tbody>
                              <?php if(count($posts)):?>
                              ...
                              <tr>
                                ...
                                <td class="text-primary"><?php echo $post->patient_case;?></td>
                                <td class="text-primary"><?php echo $post->assigned_room;?></td>
                                 <td class="text-primary"><?php echo $post->assigned_doctor;?></td>
                                <td class="text-danger"><?php echo $post->assigned_date;?></td>
                                 <td class="text-danger"><?php echo $post->assigned_by;?>
                               
                                      <td> <a class=" btn btn-warning" href="<?php echo base_url("Reception_C/doctor_assignment_fetch/{$post->patient_ID}")?>">
          ...
          $('.delete_data').click(function()
           {
            ...
            if(confirm("Are you sure you want to delete this"))
                {
                   window.location="<?php echo base_url(); ?>Doctor_C/delete_vehicle_c/"+vehicledata;
                }     
                else
                {
                  return false;
