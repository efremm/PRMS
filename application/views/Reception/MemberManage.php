      ...
      <section class="dashboard-counts section-padding">
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="container">
                       <div class="col-lg-12">  
                   <?php echo anchor('Reception_C/EmployeeReg','Add Employee',['class'=>'btn btn-info']);?>
                  </div>
                          ...
                          <table id="tbluser"  name="tbluser" class="table table-responsive table-striped table-bordered" style="width:100%">
                            <thead>
                              <tr>
                                ...
                                <th class="text-info">address</th>
                                 <th class="text-info">phone_no</th>
                            ...
                            <tbody>
                              ...
                              <tr>
                               ...
                               <td class="text-warning"><?php echo $post->department;?></td>
                                <td class="text-warning"><?php echo $post->address;?></td>
                               <td class="text-success"><?php echo $post->phone_no;?></td>
                        
                                <td> <a class=" btn btn-warning" href="<?php echo base_url("Reception_C/employee_info_fetch/{$post->emp_id}")?>">
                                          <span class="fa fa-edit"></span>
                                          </a> </td>    
                                 <td> <a class="delete_data btn btn-danger" href="#" id="<?php echo $post->emp_id; ?>"><span class="fa fa-trash"></span></a> </td>
  ...
  <script type="text/javascript">
       $(document).ready(function() {
          $('.delete_data').click(function()
           {
            var r_data=$(this).attr("id");
            if(confirm("Are you sure you want to delete this"))
                {
                   window.location="<?php echo base_url(); ?>Reception_C/delete_employee_c/"+r_data;
                }     
                else
                {
                  return false;
