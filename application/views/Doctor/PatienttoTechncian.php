      ...
      <div class="side-navbar-wrapper">
        ...
        <!--   <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-list"></i>Maintenance</a>
              <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                <li><a href="#"> <i class="fas fa-angle-right"></i>Accept </a></li>
                <li><a href="#"><i class="fas fa-chevron-circle-right"></i>  Reg </a></li>
                <li><a href="#"><i class="fas fa-angle-right"></i>Request </a></li>
                 <li><a href="#"><i class="fas fa-angle-right"></i>Assign </a></li>
              </ul>
            </li> -->
          </ul>
        </div>
          ...
          <div class="row">
            <!-- body-->
                ...
                <?php if($scsmsg = $this->session->flashdata('successmsg'));?>
                 ...
                 Patient Assign to Technician by Doctor
                  </div>
                          ...
                          <table id="tbluser"  name="tbluser" class="table table-responsive table-striped table-bordered" style="width:100%">
                            <thead>
                              <tr>
                                ...
                                <th >Gender</th>
                                 <th>Phone_No</th>
                                 <th class="text-info">assigned_room</th>
                                <th class="text-info">assigned_doctor</th>
                                <th class="text-info">assigned_date</th>
                                 <th class="text-info">assigned_by</th>
                                 <th class="text-info">assigned_status</th>
                                 <th >Edit</th>
                                 <!-- <th >Delete</th> -->
                                    </tr>
                            </thead>
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="text-success"><?php echo $post->assigned_room;?></td>
                                <td class="text-danger"><?php echo $post->assigned_doctor;?></td>
                                 <td class="text-warning"><?php echo $post->assigned_date;?></td>
                                <td class="text-warning"><?php echo $post->assigned_by;?></td>
                               <td class="text-success"><?php echo $post->assigned_status;?></td>
                                
                           
                                <td> <a class=" btn btn-warning" href="<?php echo base_url("Doctor_C/patient_assigntech_fetch/{$post->patient_seq_id}")?>">
                                          <span class="fa fa-edit"></span>
                                          </a> </td>    
                               <!--   <td> <a class="delete_data btn btn-danger" href="#" id="<?php echo $post->patient_ID; ?>"><span class="fa fa-trash"></span></a> </td> -->
