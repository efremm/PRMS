                          ...
                          <table id="tbluser"  name="tbluser" class="table table-responsive table-striped table-bordered" style="width:100%">
                            <thead>
                              <tr>
                                ...
                                <th >Gender</th>
                                 <th>Phone_No</th>
                                 <th class="text-warning">assigned_room</th>
                                <th class="text-warning">assigned_doctor</th>
                                <th class="text-warning">assigned_date</th>
                                 <th class="text-warning">assigned_by</th>
                                 <th class="text-warning">assigned_status</th>
                                 <th >Edit</th>
                                 <!-- <th >Delete</th> -->
                                    </tr>
                            </thead>
                            <tbody>
                              ...
                              <tr>
                               ...
                               <td class="text-success"><?php echo $post->assigned_status;?></td>
                                ...
                                <td> <a class=" btn btn-warning" href="<?php echo base_url("Doctor_C/patient_info_fetch/{$post->patient_seq_id}")?>">
