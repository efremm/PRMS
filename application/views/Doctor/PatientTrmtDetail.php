      ...
      <section class="dashboard-counts section-padding">
        <div class="container-fluid">
          <div class="col-lg-12 bg-info">  
                  <span class=""> Detail Patient Treatment</span>
                  </div>
          <div class="row">
            <!-- body-->
                          ...
                          <table id="tbll"  name="tbll" class="table table-responsive table-striped table-bordered" style="width:100%">
                            <thead>
                              <tr>
                                ...
                                <th >patient_treatment_drugs</th>
                                <th >consumption_interval</th>
                                <th >total_day</th>
                                  <th class="text-danger bg-warning">Assigned Nurse</th>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><?php echo $post->total_time;?></td>
                                 <td class="text-danger bg-warning"><?php echo $post->assigned_nurse;?></td>
                              ...
                              <td> <?php echo anchor("Doctor_C/update_ptreatment_fetch/{$post->patient_mt_id}",'<span class="fa fa-edit"></span>',['class'=>'btn btn-info']);?></td>
