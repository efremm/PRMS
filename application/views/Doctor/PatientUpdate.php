      ...
      <section class="dashboard-counts section-padding">
        <div class="container">
          <div class="row">
            ...
            <!-- body-->
              <form   method="post" action="<?php echo base_url()?>Doctor_C/update_Patient">
                 <div class="container row">
                  <div class="col-lg-12"> <h4 style="font-family: sans-serif;">Edit  Data</h4></div>
                        <hr>
                   ...
                   if(isset($fetch_data))
                     ...
                     <div class="form-label-group col-lg-4">
                        ...
                        <input  type="text" class="form-control text-danger" id="patientid" name="patientid" placeholder="patientid"  autofocus readonly="" 
                      ...
                      <input type="hidden" name="hidden_id" value="<?php  echo $row->patient_ID;?>" required>
                        <input type="submit" value="Update" class="btn btn-info" name="update"/>
                            ...
                            <?php echo anchor('Doctor_C/PatientManage','Back',['class'=>'btn btn-defualt']);?>
