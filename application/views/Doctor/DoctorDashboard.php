...
<html>
  ...
  <body>
    ...
    <nav class="side-navbar">
      ...
      <!--  <li><a href="#" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-list"></i>Patient Result Managment</a>
              <ul id="" class="collapse list-unstyled ">
                <li><a href="#"> <i class="fas fa-angle-right"></i>Patient to Technician</a></li>
                <li><a href="#"><i class="fas fa-angle-right"></i>Patient to Technician</a></li>
    ...
    <div class="page">
      ...
      <section class="dashboard-counts section-padding">
        <div class="container-fluid">
          <div class="row">
               <!--  <input type="text" id="hidden_name" name="hidden_name" value="<?php echo $this->session->userdata('username');?>">
                 <input type="text" name="hidden_id" value="<?php echo $this->session->userdata('user_id');?>" required> -->
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Total Patient</strong>
                  <div class="count-number text-danger"><?php echo $cnt_Patient;?></div>
                </div>
              </div>
            </div>
            <!-- Count item widget-->
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Total Treated Patient</strong><div class="count-number text-danger"><?php echo $cnt_ptreatment;?></div>
                </div>
              </div>
            </div>
