    ...
    <nav class="side-navbar">
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <li><a href="<?php echo base_url('Patient_C/PatientDashboard')?>"> <i class="fa fa-home"></i>Home</a></li>

             <li> <a class="fa fa-user" href="<?php echo base_url('Patient_C/ViewTechHelp')?>"><i class=""></i>View Help </a></li>
              <li> <a class="fa fa-user" href="<?php echo base_url('Patient_C/RequestRegManage')?>"><i class=""></i>Request Help</a></li>
               <li> <a class="fa fa-user" href="<?php echo base_url('Patient_C/ViewStatus')?>"><i class=""></i>View vehicle Status</a></li>
