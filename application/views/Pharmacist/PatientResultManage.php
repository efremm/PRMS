                          ...
                          <table id="tbluser"  name="tbluser" class="table table-responsive table-striped table-bordered" style="width:100%">
                            <thead>
                              <tr>
                                ...
                                <th >Gender</th>
                                 <th>Phone_No</th>
                                 <th class="bg-info">assigned_room</th>
                                <th class="bg-info">assigned_doctor</th>
                                <th class="bg-info">assigned_date</th>
                                 <th class="bg-info">assigned_by</th>
                                 <th class="bg-info">assigned_status</th>
