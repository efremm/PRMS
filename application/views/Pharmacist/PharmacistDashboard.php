                            ...
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item dropdown">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="<?php echo base_url('Pharmacist_C/PharmacistDashboard')?>"><i class="fa fa-user"></i>Home</a>
          ...
          <div class="row">
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name bg-info"><strong class="text-uppercase">All Patient</strong>
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name bg-success">
                  <strong class="text-uppercase">Patient Treated</strong>
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name bg-warning"><strong class="text-uppercase">Total Patient</strong>
