...
<html>
  <head>
    ...
    <title> Kolfe Health Center  Date:-________ </title>
                          ...
                          <table id="tbll"  name="tbll" class="table table-responsive table-striped table-bordered" style="width:100%">
                            <thead>
                              <tr>
                                <th >patient_ID</th>
                                <!-- <th >Patient Case</th> -->
                               <th class="text-danger bg-primary">Patient Detail Case</th>
                                 <!-- <th>Drug Type</th> -->
                                <th >Medication Type</th>
                                <th >Patient Treatment Drugs</th>
                                <th >Dosage</th>
                                <th >No of Days/Total Time</th>
                                <!-- <th class="text-danger bg-warning">checkup Time</th> -->
                                <!-- <th class="text-danger bg-primary">checked Date</th>
                                <th class="text-danger bg-primary">ckecked By</th> -->
                                <th class="text-danger bg-info">Pharmacist Approval</th>
                                <th class="text-danger bg-info">Medicine Status</th>
                                 <th class="text-danger bg-info">price</th>
                               <!--   <th>Update</th>
                                 <th>Delete</th> -->
                                    </tr>
                            </thead>
                            <tbody>
                             ...
                             <td class="text-danger bg-info"><?php echo $post->pharmacist_approval;?></td>
                              ...
                              <td class="text-danger bg-info"><?php echo $post->price;?></td> 
