...
<html>
           ...
           <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/sidemenu/css/style.blue.css'?>">
            ...
            <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/sidemenu/css/style.green.css'?>">
             <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/sidemenu/css/fontastic.css'?>">
              ...
              <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/css/custom-efm.css'?>">
  ...
  <body class="bgc">
    ...
    <div class="row col-lg-12">
        ...
        <div class="card text-white bg-info col-lg-3">
          <i class="fa fa-user fa-4x text-gray-100"></i>
            <div class="card-header" style="background-color: "><h3><strong>All Users</strong></h3></div>
            <div class="card-body">
        ...
        <div class="card text-white bg-info col-lg-3">
          <i class="fa fa-user fa-4x text-gray-100"></i>
            <div class="card-header" style="background-color: "><h3><strong>Active Users</strong></h3></div>
            <div class="card-body">
        ...
        <div class="card text-white bg-info col-lg-3">
          <i class="fa fa-user fa-4x text-gray-100"></i>
            <div class="card-header" style="background-color: "><h3><strong>Inactive Users</strong></h3></div>
            <div class="card-body">
